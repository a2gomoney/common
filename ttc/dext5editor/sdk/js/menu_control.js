...
var arrThirdMenu = [
    ...
    [
        ['7' + G_vertical + '1' + G_vertical + 'InitXml' + G_vertical + 'html/client/_s_InitXml.html',
         ...
         '7' + G_vertical + '1' + G_vertical + 'DevelopLanguage' + G_vertical + 'html/client/_s_DevelopLanguage.html',
        ...
        '7' + G_vertical + '1' + G_vertical + '[PL]AutoPluginUpdate' + G_vertical + 'html/client/_s_AutoPluginUpdate.html',
        ...
        '7' + G_vertical + '1' + G_vertical + '[PL]RemoveTempFolderDataDay' + G_vertical + 'html/client/_s_RemoveTempFolderDataDay.html',
        ...
        '7' + G_vertical + '1' + G_vertical + 'AutoInsertAlt' + G_vertical + 'html/client/_s_AutoInsertAlt.html',
        ...
        '7' + G_vertical + '1' + G_vertical + 'SkipConfirm' + G_vertical + 'html/client/_s_SkipConfirm.html',
        '7' + G_vertical + '1' + G_vertical + 'NewDocumentResetAll' + G_vertical + 'html/client/_s_NewDocumentResetAll.html',
        '7' + G_vertical + '1' + G_vertical + 'KeepTableWidthLikeWord' + G_vertical + 'html/client/_s_KeepTableWidthLikeWord.html',
        '7' + G_vertical + '1' + G_vertical + 'ListSpaceSize' + G_vertical + 'html/client/_s_ListSpaceSize.html',  // 글머리 간격 조절 sdk 추가 by seho 24.08.13
        '7' + G_vertical + '1' + G_vertical + 'ExpandListItem' + G_vertical + 'html/client/_s_ExpandListItem.html'],  // 글머리 확장 기능 sdk 추가 - by seho 24.09.06
        ['7' + G_vertical + '1' + G_vertical + 'DEXT5Editor' + G_vertical + 'html/client/_m_Dext5editor.html',
         ...
         '7' + G_vertical + '1' + G_vertical + 'doPrint' + G_vertical + 'html/client/_m_doPrint.html',
         '7' + G_vertical + '1' + G_vertical + 'doPrintPreview' + G_vertical + 'html/client/_m_doPrintPreview.html',
         // sdk 추가 - by LimSW 22.09.21
         ...
         '7' + G_vertical + '1' + G_vertical + 'resetEditor' + G_vertical + 'html/client/_m_resetEditor.html',
         '7' + G_vertical + '1' + G_vertical + 'applyClassOnSelection' + G_vertical + 'html/client/_m_applyClassOnSelection.html'],
...
var arrSearchWordMenu = [
    ...
    [
        [
            ...
            ['Event.BeforeAddFile', 'dext_editor_before_add_file_event를 설정', '다이얼로그에서 파일 추가 시 발생합니다.'],
            ...
            ['AutoInsertAlt', '멀티 이미지 삽입 시 img 태그에 alt 속성을 넣어 주도록 설정'],
            ['ImgPreview', '이미지 미리보기 창 기능 설정'],
            ['MaxTotalFileSize', '이미지, 파일, 비디오 등 삽입 시 제한할 content의 총 사이즈 설정'],
            ['SkipConfirm', '새 문서, 템플릿 선택 시 confirm 사용 여부 설정'],
            ['NewDocumentResetAll', '새 문서 동작 시 추가된 css, js, title 의 초기화 여부 설정'],
            ['KeepTableWidthLikeWord', '테이블의 좌/우 셀 삽입 시 워드와 동일하게 동작 설정'],
            ['ListSpaceSize', '글머리 생성시 생성 간격 조절 설정'],   // 글머리 간격 조절 sdk 추가 by seho 24.08.13
            ['ExpandListItem', '글머리 종류 확장 설정']   // 글머리 확장 기능 sdk 추가 by seho 24.09.06
        ],
        [
            ['DEXT5Editor', '생성'],
            ...
            ['resetEditor', '에디터 작성내용 및 추가된 css, js, title 등을 초기화'],
            ['applyClassOnSelection', '선택한 영역에 특정 class 를 추가/제거']
        ],
        [
            ...
            ['BeforeAddFile', '다이얼로그에서 파일 추가 시 발생합니다.']
        ]
    ],
    [
        ['기본 에디터 생성'],
